...
const Requests = {
  ...
  fetchUpcoming: `${TMDB_BASE_URL}/movie/upcoming?api_key=${API_KEY}&include_adult=false&include_video=false&language=en-US&page=1&sort_by=popularity.desc&region=US|CA`,
  fetchVideos: (movieId) => {
